...
const heroStyles = `
  ...
  .hero-greeting {
    font-family: 'DM Mono', monospace; font-size: 12px; color: #4F7FFF;
  ...
  .hero-uni {
    font-family: 'DM Mono', monospace; font-size: 14px; color: #6B7A99;
    margin-bottom: 24px;
  }
  .hero-typing {
    font-family: 'DM Mono', monospace; font-size: 16px; color: #6B7A99;
    min-height: 28px; margin-bottom: 40px;
  }
  .hero-typing-prefix { color: #4F7FFF; }
  @keyframes blink { 0%,100%{opacity:1} 50%{opacity:0} }
  .hero-cursor { animation: blink 0.8s step-end infinite; color: #4F7FFF; }
  ...
  .hero-btn-primary {
    ...
    background: #4F7FFF; color: #06091A; padding: 14px 32px;
    border-radius: 8px; border: none; text-decoration: none;
    transition: all 0.3s ease; display: inline-block;
  }
  .hero-btn-primary:hover { background: #6A93FF; transform: translateY(-2px); color: #06091A; }
  .hero-btn-outline {
    font-family: 'Syne', sans-serif; font-weight: 600; font-size: 15px;
    background: transparent; color: #4F7FFF; padding: 14px 32px;
    border-radius: 8px; border: 1.5px solid #4F7FFF; text-decoration: none;
    transition: all 0.3s ease; display: inline-block;
  }
  .hero-btn-outline:hover { background: rgba(79,127,255,0.08); transform: translateY(-2px); color: #4F7FFF; }

  .hero-stats { display: flex; gap: 20px; flex-wrap: wrap; justify-content: center; }
  .hero-stat-card {
    background: #0D1230; border-radius: 14px; padding: 22px 26px;
    transition: all 0.3s ease; min-width: 155px; flex: 1; max-width: 240px;
  }
  .hero-stat-card.accent-teal {
    border: 1px solid rgba(79,127,255,0.3);
    box-shadow: 0 0 24px rgba(79,127,255,0.12);
  }
  .hero-stat-card.accent-blue {
    border: 1px solid rgba(155,109,255,0.3);
    box-shadow: 0 0 24px rgba(155,109,255,0.12);
  }
  .hero-stat-card:hover { transform: translateY(-5px); }
  .hero-stat-card.accent-teal:hover { box-shadow: 0 0 32px rgba(79,127,255,0.32); }
  .hero-stat-card.accent-blue:hover { box-shadow: 0 0 32px rgba(155,109,255,0.32); }
  .hero-stat-value {
    font-family: 'Syne', sans-serif; font-size: 30px; font-weight: 700;
    line-height: 1; margin-bottom: 6px;
  }
  .hero-stat-value.teal { color: #4F7FFF; }
  .hero-stat-value.blue { color: #9B6DFF; }
  .hero-stat-label {
  ...
  .hero-scroll-text {
    font-family: 'DM Mono', monospace; font-size: 10px; color: #4F7FFF;
